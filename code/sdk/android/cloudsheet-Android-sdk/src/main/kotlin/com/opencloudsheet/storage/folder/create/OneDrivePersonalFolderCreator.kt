 ...
 *
 * Uses the Microsoft Graph API /me endpoint to create folders in the authenticated user's drive.
 ...
 */
class OneDrivePersonalFolderCreator(
    ...
    companion object {
        private const val TAG = "OneDrivePersonalFolderCreator"
    }
